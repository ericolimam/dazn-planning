  ...
  try {
    ...
    const requestBody: any = {
      ...
      COLUMNS: [
        ...
        { ALIAS: "NARRATOR_ID", FORMAT: "ID", ATTR_NM: "PROG_ID.NARRATOR_RF" },
        { ALIAS: "STATE_EVENT", FORMAT: "NAME", ATTR_NM: "PROG_ID.STATE_EVENT_RF" },
        { ALIAS: "STATE_EVENT_ID", FORMAT: "ID", ATTR_NM: "PROG_ID.STATE_EVENT_RF" },
        { ALIAS: "COMMENTATOR", ATTR_NM: "PROG_ID.COMMENTATOR" },
        { ALIAS: "TIME_BEFORE", ATTR_NM: "PROG_ID.SATELITESTART" },
        { ALIAS: "TIME_ENDING", ATTR_NM: "PROG_ID.SATELITEEND" }
      ]
    };
